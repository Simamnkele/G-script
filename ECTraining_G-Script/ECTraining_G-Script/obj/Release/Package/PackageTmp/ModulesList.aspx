...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="form-group" aria-sort="ascending" draggable="true">
        ...
        <asp:GridView ID="gvModulesData"  runat="server" AutoGenerateColumns="False" AutoGenerateEditButton="True" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" OnRowCancelingEdit="gvModulesData_RowCancelingEdit" OnRowEditing="gvModulesData_RowEditing" OnRowUpdating="gvModulesData_RowUpdating" Width="767px" AutoGenerateDeleteButton="True" OnRowDeleting="gvModulesData_RowDeleting"  Height="176px" GridLines="Horizontal">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
        ...
        <br />
        <br />
        <asp:Button ID="btnAddModule" CssClass="btn btn-primary" runat="server" Text="Add New Module" OnClick="btnAddModule_Click" />
        <br />
        <br />
