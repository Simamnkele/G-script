<%@ Page Language="C#" MasterPageFile="~/Site.Admin.Master" AutoEventWireup="true" CodeBehind="UpdateModule.aspx.cs" Inherits="ECTraining_G_Script.UpdateModule" %>
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Label ID="lblModuleNo" Visible="false" runat="server" Text='<%# Eval("ModuleNo") %>'></asp:Label>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidatorDescription" runat="server" ForeColor="Red" ErrorMessage="Description is Required" ControlToValidate="txtDesc" ></asp:RequiredFieldValidator>
         ...
         <br /><br />
        <table><tr><td class="btn pull-left"><asp:Button ID="btnUpdate" CssClass="btn btn-success" runat="server" Text="UPDATE" Width="86px" OnClick="btnUpdate_Click" /></td><td class="btn pull-right"><asp:Button ID="btnCancel" CssClass="btn btn-danger" runat="server" Text="CANCEL" OnClick="btnCancel_Click" CausesValidation="False" /></td></tr></table>
